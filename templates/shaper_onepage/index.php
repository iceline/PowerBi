...
$activeClass = (isset($active->alias)) ? $active->alias : '' ;
...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, jquery.nav.js') // JS Files
...
<body class="<?php echo $this->helix3->bodyClass( $body_classes ) . ' ' . $activeClass; ?>">
